...
for _ in range(10):
    ...
    lr = secure_random.choice([0.01, 0.01, 0.01, 0.005])
    zeta = secure_random.choice([0.01, 0.03, 0.06, 0.1])
    sz = secure_random.choice([10, 6, 3])
    temperature = 1.
    energy_gap, num_partitions = secure_random.choice([(0.001, 10000)])
